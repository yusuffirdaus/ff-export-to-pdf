...
class EmployeeDetailWidget extends StatefulWidget {
  const EmployeeDetailWidget({
    super.key,
    required this.stdDoc,
  });

  final StudentsRecord? stdDoc;

  @override
  _EmployeeDetailWidgetState createState() => _EmployeeDetailWidgetState();
}
...
class _EmployeeDetailWidgetState extends State<EmployeeDetailWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??=
        TextEditingController(text: widget.stdDoc?.fullname);
