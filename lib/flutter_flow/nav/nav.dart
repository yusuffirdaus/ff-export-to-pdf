      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'FormPage')
        ...
        FFRoute(
          name: 'StudnetsListPage',
          path: '/studnetsListPage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'StudnetsListPage')
              : const StudnetsListPageWidget(),
        ),
        FFRoute(
          name: 'ChatPage',
          path: '/chatPage',
